    ...
    return (
      ...
      >
        <Loader isFetching={isFetching} error={error}>
          <div className="user-single-dialog-content">
            <div className="user-single-dialog-content__images">
              {machine.imagesIds &&
                machine.imagesIds.map(imageId => (
                  <img
                    key={imageId}
                    className="user-single-dialog-content__image"
                    src={`${FILES}/${imageId}`}
                    alt={machine.name}
                  />
                ))}
            ...
            <p>
              <span className="user-single-dialog-content__section-title">
                Название:
              </span>{' '}
              {machine.name}
            </p>
            <p>
              <span className="user-single-dialog-content__section-title">Тип:</span>{' '}
              {machine.type && machine.type.name}
            </p>
            <p className="user-single-dialog-content__section-title">
              Характеристики:{' '}
            </p>
            <ul>
            ...
            <p className="user-single-dialog-content__section-title">Описание: </p>
            <p className="user-single-dialog-content__description">
              {machine.description}
            </p>
          </div>
        </Loader>
